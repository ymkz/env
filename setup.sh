...
ln -nfs $HOME/workspace/ghq/github.com/ymkz/dotfiles/latexmk $HOME/.latexmk
ln -nfs $HOME/workspace/ghq/github.com/ymkz/dotfiles/starship $HOME/.config/starship.toml
